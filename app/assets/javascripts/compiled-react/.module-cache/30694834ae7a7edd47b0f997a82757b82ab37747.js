    ...
    if (this.props.currentChar === "Louis") {
      return (
        React.createElement("div", {className: "active-chars"}, 
          ...
          React.createElement("div", {ref: "donna", className: "character donna"})
        )
      )
    } 
      ...
      return ( 
        React.createElement("div", {className: "active-chars"}, 
          React.createElement("div", {ref: "louis", className: "character louis", onClick: this.handleClick}), 
