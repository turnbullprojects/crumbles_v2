  ...
  render: function() {
    ...
    return (
      React.createElement("div", {idName: "mashup-container"}, 
        React.createElement(PhraseInput, {onInput: this.handlePhraseInput}), 
...
var PhraseInput = React.createClass({displayName: "PhraseInput",
  ...
  render: function() {
    return (
      React.createElement(TextBox, {onWordInput: this.handleText})
    );
  }
});
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {idName: "player"}, 
        React.createElement("video", {ref: "video", type: "video/mp4", controls: true, id: "master-vid"}), 
...
React.render(React.createElement(MashupContainer, {dictionary: StandardDict}), document.getElementById("main"));
